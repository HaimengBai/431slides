...
for the `sbp` results from the `dm192` tibble. It does this while making use of several functions built specifically for this course, and contained in the script `Love-boost.R` which is also included in the Markdown document.
