...
4. Which states are in the midwest? (fill out survey)
...
Answer Sketch for Assignment 1 posted on Friday afternoon. [Visit this link for details](https://github.com/THOMASELOVE/431homework/tree/master/HW1). The PDF is password protected, rather than "invalid" as Github suggests when you try to display it.

1. R Markdown for Answer Sketch is also available. 
2. Grading rubric for Assignment 1 is coming Thursday.
3. No, I did not expect you to write a 15 page response.
4. No, I do not plan to provide a new template for Assignment 2, but I strongly suggest you look over Claudia's slide deck, as linked in the Class 7 README.
