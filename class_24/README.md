...
2. The Projects
    ...
    - **Drop All Missing Values** I suggest you drop all rows with missing data from your tibble for your project, rather than imputing, if you're having any trouble. 
        - `newdata <- na.omit(olddata)` will usually do it. 
        - You are welcome to try imputing, certainly, and we'll discuss this in detail in 432, but, realistically, we won't get to it this term.
