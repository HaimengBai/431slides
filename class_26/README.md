...
2. Remaining Course Deliverables
    ...
    - **Quiz 3** will be made available on 2017-12-07 by 5 PM and is due at noon on Tuesday **2017-12-12** (*note change*). 
        ...
        - Another tip for your Project and the Quiz is to familiarize yourself with the following functions from the `forcats` package: `fct_recode`, `fct_collapse`, `fct_relevel`, `fct_reorder`, `fct_count` and `fct_unique`. They're all useful. The easiest ways to learn about them are to play around with them, and read the Factors chapter of [R for Data Science](http://r4ds.had.co.nz/factors.html).
